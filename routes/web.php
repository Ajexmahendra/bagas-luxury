...
Route::post('/booking/submit', [BookingController::class, 'cart_submit'])->name('cart_submit')->middleware(['customer:customer']);
Route::get('/cart', [BookingController::class, 'cart_view'])->name('cart')->middleware(['customer:customer']);
Route::get('/cart/delete/{id}', [BookingController::class, 'cart_delete'])->name('cart_delete')->middleware(['customer:customer']);
Route::get('/checkout', [BookingController::class, 'checkout'])->name('checkout')->middleware(['customer:customer']);
Route::get('/transaksi', [BookingController::class, 'transaksi'])->name('transaksi')->middleware(['customer:customer']);
...
Route::group(['middleware' => ['customer:customer']], function () {
    ...
    Route::get('/order/{id}/review', [CustomerOrderController::class, 'review'])->name('review');
    Route::post('/order/{id}/review', [CustomerOrderController::class, 'review_post'])->name('review_post');
});
...
Route::group(['middleware' => ['admin:admin']], function () {
    ...
    Route::get('/admin/reviews', [AdminRoomController::class, 'get_reviews'])->name('get_reviews');
});
