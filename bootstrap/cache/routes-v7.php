...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::DhuW75zqYhu0uxUR',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::7RzUABUxMudj4Kup',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/p(?|ost/([^/]++)(*:24)|ayment/stripe/([^/]++)(*:53))|/subscriber/verify/([^/]++)/([^/]++)(*:97)|/r(?|oom/([^/]++)(*:121)|eset\\-password/([^/]++)/([^/]++)(*:161))|/c(?|art/delete/([^/]++)(*:194)|ustomer/invoice/([^/]++)(*:226))|/transaksi/(?|([^/]++)(*:257)|bank/([^/]++)(*:278))|/admin/(?|r(?|eset\\-password/([^/]++)/([^/]++)(*:333)|oom/(?|edit/([^/]++)(*:361)|update/([^/]++)(*:384)|delete/([^/]++)(*:407)|gallery/(?|([^/]++)(*:434)|store/([^/]++)(*:456)|delete/([^/]++)(*:479))))|customer/change\\-status/([^/]++)(*:522)|order/(?|invoice/(?|([^/]++)(*:558)|edit/([^/]++)(*:579)|update(*:593))|delete/([^/]++)(*:617))|slide/(?|edit/([^/]++)(*:648)|update/([^/]++)(*:671)|delete/([^/]++)(*:694))|f(?|eature/(?|edit/([^/]++)(*:730)|update/([^/]++)(*:753)|delete/([^/]++)(*:776))|aq/(?|edit/([^/]++)(*:804)|update/([^/]++)(*:827)|delete/([^/]++)(*:850)))|testimonial/(?|edit/([^/]++)(*:888)|update/([^/]++)(*:911)|delete/([^/]++)(*:934))|p(?|ost/(?|edit/([^/]++)(*:967)|update/([^/]++)(*:990)|delete/([^/]++)(*:1013))|hoto/(?|edit/([^/]++)(*:1044)|update/([^/]++)(*:1068)|delete/([^/]++)(*:1092)))|video/(?|edit/([^/]++)(*:1125)|update/([^/]++)(*:1149)|delete/([^/]++)(*:1173))|amenity/(?|edit/([^/]++)(*:1207)|update/([^/]++)(*:1231)|delete/([^/]++)(*:1255)))|/order/([^/]++)/review(?|(*:1291)))/?$}sDu',
    ),
    3 => 
    array (
      24 => 
  ...
  array (
    ...
    return $request->user();
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000008bc0000000000000000";}";s:4:"hash";s:44:"ZZzdDCgeYMAziyhA1A30eZ3fuXTNSuiI2woDH6YO9jU=";}}',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'generated::7RzUABUxMudj4Kup',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi',
        'controller' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi_detail',
        'controller' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi_detail',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi_detail_bank',
        'controller' => 'App\\Http\\Controllers\\Front\\BookingController@transaksi_detail_bank',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'transaksi_detail_bank',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\BookingController@kirimbukti',
        'controller' => 'App\\Http\\Controllers\\Front\\BookingController@kirimbukti',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Front\\BookingController@callback',
        'controller' => 'App\\Http\\Controllers\\Front\\BookingController@callback',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Customer\\CustomerOrderController@review',
        'controller' => 'App\\Http\\Controllers\\Customer\\CustomerOrderController@review',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Customer\\CustomerOrderController@review_post',
        'controller' => 'App\\Http\\Controllers\\Customer\\CustomerOrderController@review_post',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'admin/order/invoice/edit/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminOrderController@invoice_edit',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminOrderController@invoice_edit',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'admin_invoice_edit',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'admin/order/invoice/update',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminOrderController@invoice_update',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminOrderController@invoice_update',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'admin_invoice_update',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\AdminRoomController@get_reviews',
        'controller' => 'App\\Http\\Controllers\\Admin\\AdminRoomController@get_reviews',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
