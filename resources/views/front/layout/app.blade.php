                ...
                <div class="col-md-6 right-side">
                    <ul class="right">
                        ...
                        @if ($global_page_data->cart_status == 1)
                            <li class="menu"><a href="{{ route('cart') }}"
                                    style="color:white !important;">{{ $global_page_data->cart_heading }} @if (session()->has('cart_room_id'))
                        ...
                        @if ($global_page_data->checkout_status == 1)
                            <li class="menu"><a href="{{ route('checkout') }}"
                                    style="color:white !important;">{{ $global_page_data->checkout_heading }}</a></li>
                        @endif
                        ...
                        @if (!Auth::guard('customer')->check())
                            ...
                            @if ($global_page_data->signup_status == 1)
                                <li class="menu"><a href="{{ route('customer_signup') }}"
                                        style="color:white !important;">{{ $global_page_data->signup_heading }}</a>
                                </li>
                            @endif

                            @if ($global_page_data->signin_status == 1)
                                <li class="menu"><a href="{{ route('customer_login') }}"
                                        style="color:white !important;">{{ $global_page_data->signin_heading }}</a>
                                </li>
                            @endif
                        @else
                            <li class="menu"><a href="{{ route('transaksi') }}"
                                    style="color:white !important;">Transaksi</a></li>
                            <li class="menu"><a href="{{ route('customer_home') }}"
                ...
                <div class="col-md-3">
                    <div class="item">
                        ...
                        <ul class="useful-links">
                            ...
                            @if ($global_page_data->photo_gallery_status == 1)
                                <li><a
                                        href="{{ route('photo_gallery') }}">{{ $global_page_data->photo_gallery_heading }}</a>
                                </li>
                            @endif

                            @if ($global_page_data->video_gallery_status == 1)
                                <li><a
                                        href="{{ route('video_gallery') }}">{{ $global_page_data->video_gallery_heading }}</a>
                                </li>
                            @endif
                ...
                <div class="col-md-3">
                    <div class="item">
                        ...
                        <ul class="useful-links">
                            ...
                            <li><a href="{{ route('admin_login') }}" target="__blank">Login Admin</a></li>
                    ...
                    <div class="item">
                        ...
                        <ul class="social">
                            ...
                            @if ($global_setting_data->facebook != '')
                                <li><a href="{{ $global_setting_data->facebook }}"
                                        style="background-color: #000000 !important;"><i
                                            class="fa fa-facebook-f"></i></a></li>
                            @endif

                            @if ($global_setting_data->twitter != '')
                                <li><a href="{{ $global_setting_data->twitter }}"
                                        style="background-color: #000000 !important;"><i
                                            class="fa fa-twitter"></i></a></li>
                            @endif

                            @if ($global_setting_data->linkedin != '')
                                <li><a href="{{ $global_setting_data->linkedin }}"
                                        style="background-color: #000000 !important;"><i
                                            class="fa fa-linkedin"></i></a></li>
                            @endif

                            @if ($global_setting_data->pinterest != '')
                                <li><a href="{{ $global_setting_data->pinterest }}"
                                        style="background-color: #000000 !important;"><i
                        ...
                        <form action="{{ route('subscriber_send_email') }}" method="post"
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-dark"
                                    style="background-color: #000000 !important;" value="Subscribe Now">
                            </div>
                        </form>
                    </div>
                </div>
