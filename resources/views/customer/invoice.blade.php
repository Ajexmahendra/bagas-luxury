                        ...
                        <div class="invoice-title">
                            ...
                            <div class="invoice-number">Order #{{ $order->order_no }}
                                ...
                                @elseif($order->status == 'Completed')
                                    <span class="badge badge-success">Order Status Berhasil</span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <address>
                                    ...
                                    <u>{{ Auth::guard('customer')->user()->name }}<br></u>
                                    Alamat : {{ Auth::guard('customer')->user()->address }}<br>
                                    No HP : {{ Auth::guard('customer')->user()->phone }}
                                </address>
                            </div>
